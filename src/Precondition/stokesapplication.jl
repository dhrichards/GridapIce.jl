...
function main(distribute,np,nc)
  ...
  model = CartesianDiscreteModel(parts,np,domain,nc,isperiodic=(true,false))
  ...
  writevtk(get_triangulation(model),"test", cellfields=["uh"=>uh])
end

rank_partition = (2,2)
with_mpi() do distribute
  main(distribute,rank_partition,(10,10))
end